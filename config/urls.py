...
urlpatterns = [
    ...
    # API v1 (kept for backward compatibility)
    ...
    # API admin — what the gateway forwards (/api/admin/** → here)
    path("api/admin/auth/", include("apps.accounts.urls")),
    path("api/admin/vendors/", include("apps.vendors.urls")),
    path("api/admin/categories/", include("apps.categories.urls")),
    path("api/admin/products/", include("apps.products.urls")),
    path("api/admin/inventory/", include("apps.inventory.urls")),
    path("api/admin/images/", include("apps.images.urls")),
